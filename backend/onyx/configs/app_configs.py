...
UNCENSORED_API_URL = os.environ.get("UNCENSORED_API_URL")
UNCENSORED_API_KEY = os.environ.get("UNCENSORED_API_KEY")
UNCENSORED_DEFAULT_CHAT_MODEL = os.environ.get(
    "UNCENSORED_DEFAULT_CHAT_MODEL", "uncensored-lm"
)
